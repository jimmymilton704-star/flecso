<header class="topbar">
    ...
    <div class="topbar__actions">
        ...
        <!-- Notifications -->
        <div class="notify-wrap">
            <button class="icon-btn icon-btn--notify" aria-label="Notifications" id="notifyBtn">
                <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9M13.73 21a2 2 0 0 1-3.46 0" />
                </svg>
                <span class="notify-badge" id="notifyBadge">3</span>
            </button>
            <div class="notify-pop" id="notifyPop" role="dialog" aria-label="Notifications">
                <header class="notify-pop__head">
                    <div>
                        <h3>Notifications</h3>
                        <p class="muted" id="notifyCount">3 unread</p>
                    </div>
                    <button class="btn btn--sm btn--ghost" id="notifyMarkAll">Mark all read</button>
                </header>
                <div class="notify-pop__body" id="notifyList"></div>
                <footer class="notify-pop__foot"><a href="settings.html#notifications">Notification settings</a><a
                        href="#" class="link-primary">View all</a></footer>
            </div>
        </div>
        ...
        <div class="notify-wrap">
            ...
            <div class="notify-pop profile-pop" id="profilePop" role="menu">
                ...
                <div class="notify-pop__body" style="padding:6px">
                    <button class="profile-link" data-action="profile"><svg viewBox="0 0 24 24" width="16" height="16"
                            fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="12" cy="8" r="4" />
                            <path d="M4 21c0-4 4-7 8-7s8 3 8 7" />
                        </svg><span>View profile</span></button>
                    <button class="profile-link" data-action="settings"><svg viewBox="0 0 24 24" width="16" height="16"
                            fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <button class="profile-link" data-action="billing"><svg viewBox="0 0 24 24" width="16" height="16"
                            fill="none" stroke="currentColor" stroke-width="2">
                            <rect x="3" y="6" width="18" height="12" rx="2" />
                            <path d="M3 10h18" />
                        </svg><span>Billing</span></button>
                    <button class="profile-link" data-action="help"><svg viewBox="0 0 24 24" width="16" height="16"
                            fill="none" stroke="currentColor" stroke-width="2">
                ...
                <footer class="notify-pop__foot" style="padding:8px">
                    <a class="profile-link--danger"
                        style="width:100%;justify-content:center" href="{{ route('logout') }}"><svg viewBox="0 0 24 24" width="16" height="16"
                            fill="none" stroke="currentColor" stroke-width="2">
