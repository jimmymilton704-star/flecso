        ...
        <div class="leaderboard-podium">
            ...
            @if (isset($top3[0]))
                <div class="podium-card podium-card--1">
                    ...
                    <div class="score-badge" style="font-size: 1.1rem; padding: 6px 16px;">{{ $top3[0]['final_score'] }} Pts
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display:flex; align-items:center; gap:12px;">
                                        <div class="driver-avatar"
                                            style="width:36px; height:36px; font-size:14px; margin:0; flex-shrink:0;">
                                            @if ($row['driver']->driver_photo)
                                                <img src="{{ asset('storage/' . $row['driver']->driver_photo) }}"
                                                    alt="Avatar">
                                            @else
                                ...
                                <td>
                                    ...
                                    <div class="mini-progress">
                                        <div class="mini-progress-bar"
                                            style="width: {{ $row['on_time_score'] }}%; background: #10b981;"></div>
                                    </div>
                                </td>
                                <td>
                                    ...
                                    <div class="mini-progress">
                                        <div class="mini-progress-bar"
                                            style="width: {{ $row['incident_score'] }}%; background: {{ $row['incident_score'] < 70 ? '#ef4444' : '#3b82f6' }};">
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    ...
                                    <div class="mini-progress">
                                        <div class="mini-progress-bar"
                                            style="width: {{ $row['fuel_score'] }}%; background: #f59e0b;"></div>
                                    </div>
                                </td>
