...
<style>
    ...
    .al-pagination nav>div:first-child {
        font-size: 12px;
        color: var(--ink-400);
    }

    .al-pagination nav>div:last-child {
        display: flex;
        align-items: center;
        gap: 4px;
    }
    ...
    .al-pagination [rel="prev"]::before {
        content: "←";
    }

    .al-pagination [rel="next"]::after {
        content: "→";
    }
    ...
    <div class="al-filter-bar">
        <div class="al-filter-left">
            ...
            <div class="al-tabs" id="methodTabs">
                ...
                <button type="button" class="al-tab delete {{ request('method_filter') === 'DELETE' ? 'active' : '' }}"
