                    ...
                    <div class="form-grid">
                        ...
                        <div class="field">
                            ...
                            <select name="truck_type_category" required>
                                <option value="Semi-Truck"
                                    {{ old('truck_type_category', $truck->truck_type_category) == 'Semi-Truck' ? 'selected' : '' }}>
                                    Semi-Truck</option>
                                <option value="Box Truck"
                                    {{ old('truck_type_category', $truck->truck_type_category) == 'Box Truck' ? 'selected' : '' }}>
                                    Box Truck</option>
                                <option value="Refrigerated"
                                    {{ old('truck_type_category', $truck->truck_type_category) == 'Refrigerated' ? 'selected' : '' }}>
                                    Refrigerated</option>
                                <option value="Flatbed"
                                    {{ old('truck_type_category', $truck->truck_type_category) == 'Flatbed' ? 'selected' : '' }}>
                                    Flatbed</option>
                                <option value="Tanker"
                                    {{ old('truck_type_category', $truck->truck_type_category) == 'Tanker' ? 'selected' : '' }}>
                                    Tanker</option>
                            </select>
                        </div>
                        ...
                        <div class="field">
                            ...
                            <select name="type" required>
                                <option value="Heavy" {{ old('type', $truck->type) == 'Heavy' ? 'selected' : '' }}>Heavy
                                </option>
                                <option value="Medium" {{ old('type', $truck->type) == 'Medium' ? 'selected' : '' }}>Medium
                                </option>
                                <option value="Light" {{ old('type', $truck->type) == 'Light' ? 'selected' : '' }}>Light
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="field">
                            ...
                            <select name="status" required>
                                <option value="active" {{ old('status', $truck->status) == 'active' ? 'selected' : '' }}>
                                    Active</option>
                                <option value="maintenance"
                                    {{ old('status', $truck->status) == 'maintenance' ? 'selected' : '' }}>Maintenance
                                </option>
                                <option value="idle" {{ old('status', $truck->status) == 'idle' ? 'selected' : '' }}>Idle
                                </option>
                                <option value="inactive"
                                    {{ old('status', $truck->status) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="field">
                            ...
                            <select name="usage_type" required>
                                ...
                                <option value="Leased"
                                    {{ old('usage_type', $truck->usage_type) == 'Leased' ? 'selected' : '' }}>Leased
                                </option>
                                <option value="Rented"
                                    {{ old('usage_type', $truck->usage_type) == 'Rented' ? 'selected' : '' }}>Rented
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="field">
                            ...
                            <select name="vehicle_category" required>
                                ...
                                <option value="N2"
                                    {{ old('vehicle_category', $truck->vehicle_category) == 'N2' ? 'selected' : '' }}>N2
                                </option>
                                <option value="N3"
                                    {{ old('vehicle_category', $truck->vehicle_category) == 'N3' ? 'selected' : '' }}>N3
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="field">
                            ...
                            <select name="fuel_type" required>
                                ...
                                <option value="Electric"
                                    {{ old('fuel_type', $truck->fuel_type) == 'Electric' ? 'selected' : '' }}>Electric
                                </option>
                                <option value="Hybrid"
