    ...
    <div class="detail-hero">
        ...
        <div class="detail-hero__body">
            ...
            <div class="detail-hero__sub">
                ...
                <span>💰 {{ $trip->payment_amount ?? 0 }}</span>
            </div>
        ...
        <div class="detail-hero__actions">
            ...
            <a href="{{ route('trips.edit', $trip->id) }}" class="btn btn--ghost">Edit</a>

            <button class="btn btn--primary">Notify Driver</button>
    ...
    <div class="detail-grid">
        ...
        <div>
            ...
            <div class="card" style="margin-top:14px">
                <div class="card__head"><h3>Basic Details</h3></div>
            ...
            {{-- PACKAGE --}}
            <div class="card" style="margin-top:14px">
                <div class="card__head"><h3>Package Information</h3></div>
                <div class="card__body">
                    <div class="info-grid">
            ...
            {{-- DELIVERY --}}
            <div class="card" style="margin-top:14px">
                <div class="card__head"><h3>Delivery Details</h3></div>
                <div class="card__body">
                    <div class="info-grid">
        ...
        <aside class="detail-side">
            ...
            {{-- DRIVER --}}
            <div class="card">
                <div class="card__head"><h3>Driver</h3></div>
                <div class="card__body">
            ...
            {{-- TRUCK --}}
            <div class="card">
                <div class="card__head"><h3>Truck</h3></div>
                <div class="card__body">
            ...
            {{-- CONTAINER --}}
            <div class="card">
                <div class="card__head"><h3>Container</h3></div>
                <div class="card__body">
