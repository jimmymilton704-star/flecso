            ...
            <div class="auth-hero__top">
                <div class="brand-mark">
                    <svg viewBox="0 0 32 32" width="28" height="28" fill="none">
                        <path d="M6 8h20l-4 8h-12l-2 4h16" stroke="url(#g2)" stroke-width="2.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <circle cx="11" cy="24" r="2.5" stroke="url(#g2)" stroke-width="2.5" />
                        <circle cx="22" cy="24" r="2.5" stroke="url(#g2)" stroke-width="2.5" />
                        <defs>
